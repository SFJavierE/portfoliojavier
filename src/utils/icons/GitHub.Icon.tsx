...
export const GitHubIcon = ({className} : IconProps): ReactElement => (
    ...
    >
        ...
        1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 
        1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 
        ...
        1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 
